...
if (!class_exists('AccordionExpander')):
	...
	class AccordionExpander {
		...
		private function load_dependencies() {
			...
			add_shortcode('accordion_expander', array(&$this, 'accordion_short_render'));
		}
		...
		public function accordion_setup_styles() {
			wp_enqueue_style($this->plugin_slug . '-fa4', 'https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), '', 'all');
		...
		public function accordion_short_render($atts, $content = NULL) {
			...
			/**
			 * Turn off read more option for now
			 */
